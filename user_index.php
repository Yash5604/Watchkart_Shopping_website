...
<body>
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="row align-items-center">
                        ...
                        <p id="remove">to not waste time you should buy watch to know time</p></h5>
                        <a href="shooping/index.php"><button style="background:lightblue;border-radius:5px;color:blue">Buy now</button></a>
                        </div>
                    </div>
                </div>
    ...
    <br><br><br><br>
        ...
        <div class="container">
            <div class="box" style="background-color:#C0C0C0" id="box1">
            <div class="content">
            ...
            <div class="box" style="background-color:#C0C0C0" id="box2">
            <div class="content">
            ...
            <div class="box" style="background-color:#C0C0C0" id="box3">
            <div class="content">
        ...
        <button type="button" id='btn' class="btn-count"> count Here
    </button>
