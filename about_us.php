<?php
    ...
    if(isset($_SESSION['username'])){
        header('location:user_about_us.php');
    }
?>
        ...
        <div class="card">
            ...
            <div class="content">
				...
				<p><a href="https://www.linkedin.com/in/pritesh-umraniya-802a2b23a/" target="_blank"><i class="fa-brands fa-linkedin"></i></a>
                    ...
                    <a href="https://mail.google.com/mail/u/0/#inbox?compose=cSRfBTZPfqjzLkZmHbkRvgngmcrjkhXGnMZDnkCHZLpjzrSmBtZbhRVLcJPwvZsbfZdgSnTGvCmhDPMfHTLBtczVVGGlwMmFbpZNpjscDhGbgGnnjwddphtWbqRzJwTTqtTsQvFGdsqhggjXNzpCqnCmkmbjxRxq" target="_blank"><i class="fas fa-envelope email-icon"></i></a>
                </p>
